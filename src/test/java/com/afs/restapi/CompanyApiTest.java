...
class CompanyApiTest {
    ...
    void should_update_company_name() throws Exception {
        Company previousCompany = companyRepository.save(new Company(1L, "Facebook"));
    ...
    void should_find_companies_by_page() throws Exception {
        ...
        mockMvc.perform(get("/companies")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].employeeCount").exists())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[1].employeeCount").exists());
    }
